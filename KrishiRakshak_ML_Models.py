...
# Step 2: Create realistic farm sensor data with more complex patterns
...
# Step 3: Build a more powerful model using your 10K parameter capacity
...
# Calculate exact parameter count - CORRECTED METHOD
...
# Step 4: Train with validation split
...
# Step 5: Convert to TensorFlow Lite for edge deployment
